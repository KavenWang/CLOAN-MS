...
public class CacheConfiguration {
    ...
    @Bean
    public HazelcastInstance hazelcastInstance(CloanLimitProperties scfsLoanProperties) {
        ...
        config.getMapConfigs().put("com.hoperun.scfs.loan.domain.*", initializeDomainMapConfig(scfsLoanProperties));
    ...
    private MapConfig initializeDomainMapConfig(CloanLimitProperties scfsLoanProperties) {
        MapConfig mapConfig = new MapConfig();

        mapConfig.setTimeToLiveSeconds(scfsLoanProperties.getCache().getTimeToLiveSeconds());
        return mapConfig;
    }
